# 🔒 Anonymizer v1.3 - Advanced NLP-Powered Document Anonymization System
...
- **🧠 Полная интеграция NLP Service** - интеллектуальный анализ неструктурированного текста
- **� Отображение методов обнаружения** - видите какой именно алгоритм нашел данные
- **⚡ Микросервисная архитектура** - 5 независимых сервисов работают согласованно  
- **🎯 Улучшенная точность** - исправлены ложные срабатывания regex паттернов
- **� Unified Document Service** - координирует работу всех методов детекции
